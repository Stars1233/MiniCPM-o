...
* [2026.05.17] ⭐️⭐️⭐️ We release the [API service](./docs/api.md) of MiniCPM-V 4.6 and MiniCPM-o 4.5.
...
Refer to the [API Guide](./docs/api.md) for MiniCPM-V 4.5 / 4.6 and MiniCPM-o 4.5.
